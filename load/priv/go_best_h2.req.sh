...
rrdtool graph go_best_h2.req.svg \
--width 600 \
--height 200 \
--start 00:00 \
--end start+38seconds \
...
--lower-limit 0 \
--rigid \
'DEF:error=go_best_h2.rrd:error:MAX:start=1544709272:end=1544709310:step=1' \
'DEF:requests=go_best_h2.rrd:requests:MAX:start=1544709272:end=1544709310:step=1' \
'SHIFT:error:-28472' \
'SHIFT:requests:-28472' \
